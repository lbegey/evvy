...
export function VerificationBanner() {
  ...
  return (
    <div className="relative border-b border-amber-200 bg-amber-50 px-10 py-2">
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-center gap-x-2 gap-y-1 text-center text-sm text-amber-800">
      ...
      <Button
        ...
        className="absolute right-2 top-1/2 -translate-y-1/2 text-amber-600 hover:bg-amber-100 hover:text-amber-700"
      >
        <X className="h-4 w-4" />
      </Button>
    </div>
