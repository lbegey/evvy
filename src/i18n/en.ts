export const en = {
  ...
  landing: {
    ...
    pricing: {
      ...
      // One shared list rendered in both cards, so the difference reads at a glance.
      features: [
        { text: "Unlimited events", free: true, premium: true },
        { text: "Unlimited calendars with public pages", free: true, premium: true },
        { text: "Add-to-calendar buttons for every provider", free: true, premium: true },
        { text: "HTML embed for emails & websites", free: true, premium: true },
        { text: "RSVP with one-click CSV export", free: true, premium: true },
        { text: "Unlimited RSVP responses (40 max on Free)", free: false, premium: true },
        { text: "Custom RSVP questions", free: false, premium: true },
        { text: "Evvy branding fully removed", free: false, premium: true },
        { text: "Custom logo, colors and background", free: false, premium: true },
        { text: "Full analytics: page views, clicks, QR scans", free: false, premium: true },
      ],
      free: {
        name: "Free",
        price: "€0",
