...
export const fr: Translations = {
    ...
    pricing: {
      ...
      free: {
        ...
        bullets: [
          ...
          { text: "Pas de calendriers personnalisés", included: false },
        ],
  ...
  billing: {
    ...
    compare: {
      ...
      rows: [
        ...
        { free: "Pas de calendriers personnalisés", premium: "Calendriers personnalisés illimités avec pages publiques", freeIncluded: false },
      ],
    },
  },
  ...
  branding: {
    ...
    logoRoundedHint: "Arrondir les coins du logo de 8px.",
    color: "Couleur de marque",
    colorHint: "Utilisée comme couleur d'accent pour les boutons et les bordures sur vos pages d'événement publiques.",
    backgroundColor: "Couleur de fond",
    backgroundColorHint: "Utilisée comme couleur de fond de vos pages d'événement publiques.",
    backgroundImage: "Image de fond",
