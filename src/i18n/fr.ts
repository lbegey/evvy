...
export const fr: Translations = {
  ...
  eventDetail: {
    ...
    branding: {
      ...
      subtitle: "Personnalisez l'apparence de la page publique de cet événement.",
      enable: "Personnalisation propre à cet événement",
      enableHint: "Utiliser le logo et les couleurs de cet événement plutôt que la personnalisation de votre compte.",
      accountBranding: "Gérer la personnalisation du compte",
      overrideHint: "Tant qu'elle est activée, seule la personnalisation de cet événement est utilisée — celle de votre compte ne sera pas appliquée.",
      logo: "Logo",
      ...
      backgroundImageHint: "Affichée en couverture. JPG ou PNG, 5 Mo max.",
