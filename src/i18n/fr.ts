...
export const fr: Translations = {
  ...
  landing: {
    ...
    demo: {
      ...
      description:
        "Voici un calendrier public créé avec Evvy — toute une saison de conférences tech réunies sur une seule page partageable. Et voici l'embed exact que vous pouvez glisser dans n'importe quelle newsletter ou site.",
    ...
    pricing: {
      ...
      // Une seule liste affichée dans les deux cartes, pour voir la différence d'un coup d'œil.
      features: [
        { text: "Événements illimités", free: true, premium: true },
        { text: "Calendriers illimités avec pages publiques", free: true, premium: true },
        { text: "Boutons d'ajout au calendrier pour chaque fournisseur", free: true, premium: true },
        { text: "Embed HTML pour emails & sites web", free: true, premium: true },
        { text: "RSVP avec export CSV en un clic", free: true, premium: true },
        { text: "Réponses RSVP illimitées (40 max en gratuit)", free: false, premium: true },
        { text: "Questions RSVP personnalisées", free: false, premium: true },
        { text: "Mention Evvy entièrement supprimée", free: false, premium: true },
        { text: "Logo, couleurs et fond personnalisés", free: false, premium: true },
        { text: "Statistiques complètes : vues, clics, scans QR", free: false, premium: true },
      ],
      free: {
        name: "Gratuit",
        price: "0 €",
  ...
  eventDashboard: {
    kpiRsvp: "Réponses RSVP",
    kpiViews: "Vues de la page",
    kpiCalendarAdds: "Ajouts au calendrier",
    kpiQrScans: "Scans QR code",
    kpiSinceCreation: "depuis la création",
    kpiInPerson: "en présentiel",
    kpiServices: (n: number) => `${n} service${n > 1 ? "s" : ""}`,
    kpiRsvpBreakdown: (yes: number, maybe: number) => `${yes} oui · ${maybe} peut-être`,
    shareTitle: "Partager",
    shareSubtitle: "Lien public de l'événement.",
    broadcast: "Diffuser",
    rsvpSubtitle: "Suivez et gérez les réponses des invités.",
    brandingSubtitle: "Personnalisez l'apparence de la page publique.",
    livePreview: "Aperçu en direct",
    poweredBy: "Propulsé par Evvy",
    attachmentSubtitle: "PDF, image, document…",
    questionsSubtitle: "Sur le formulaire RSVP.",
    statsSubtitle: "Engagement sur la page de l'événement.",
  ...
  billing: {
    ...
    compare: {
      ...
      rows: [
        ...
        { free: "Calendriers illimités avec pages publiques", premium: "Calendriers personnalisés illimités avec pages publiques", freeIncluded: true },
      ],
    },
  },
